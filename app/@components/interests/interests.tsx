import { Flex, Text, Box, Tooltip, Badge } from "@chakra-ui/react";
          ...
          <Tooltip
            ...
            label={
              <Text>
                ...
                cranking up the tunes with your loved ones. You might wonder
                about my favorite music - let me share a glimpse:{" "}
                <Text as="span" fontWeight="bolder" display="inline">
